...
?>
    <div class="report-controls">
            ...
            <input type="button" value="<?php print lang('export_csv_label') ?>" id="export-button" class="submit button button--primary" name="export-button" title="<?php print lang('export_csv_title') ?>">
            <input type="hidden" value="<?php echo $partial_url."&method=". $method ?>" id="export-type" title="<?php print lang('purge_info') ?>"/>
            <input type="button" value="<?php echo lang('purge_label') ?>" id="purge-button" class="submit purge-button button button--primary" title="<?php echo lang('purge_title') ?>">
